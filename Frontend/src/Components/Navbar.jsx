  ...
  return (
    <div className=" justify-between pl-5 pr-8 h-12 items-center w-full flex pt-4 font-poppins">
      ...
      <div className="flex  p-1 w-[20%] gap-2 justify-around tracking-wide">
        <button onClick={()=>{window.open("https://portfolio-lime-nine-10.vercel.app/")}} className="relative overflow-hidden group bg-primary pt-1 pb-1 pl-2 pr-2 rounded-sm w-[48%] cursor-pointer text-white transition-all duration-300 ease-in-out hover:scale-105">
        ...
        <button onClick={()=>{window.open("https://github.com/Prajjwal-Saggar/CodeLoom")}} className="relative overflow-hidden group bg-primary pt-1 pb-1 pl-2 pr-2 w-[48%] rounded-sm cursor-pointer text-white transition-all duration-300 ease-in-out hover:scale-105">
          <span className="relative z-10 flex items-center justify-center">
